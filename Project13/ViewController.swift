...
//  Project13
//
//  Created by RqwerKnot on 20/10/2022.
//
...
class ViewController: UIViewController, UIImagePickerControllerDelegate & UINavigationControllerDelegate {
    ...
    @IBAction func save(_ sender: Any) {
        if let imageToSave = imageView.image {
            ...
            let ac = UIAlertController(title: "Nothing to save", message: "First add a picture and select a filter.", preferredStyle: .alert)
    ...
    func setFilter(_ action: UIAlertAction){
        ...
        filters.setTitle(filter, for: .normal)
